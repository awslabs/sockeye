...
OPTIMIZERS = [OPTIMIZER_ADAM, OPTIMIZER_BERTADAM, OPTIMIZER_EVE, OPTIMIZER_NADAM, OPTIMIZER_RMSPROP, OPTIMIZER_SGD,
              OPTIMIZER_NAG, OPTIMIZER_ADAGRAD, OPTIMIZER_ADADELTA]

LR_SCHEDULER_FIXED_RATE_INV_SQRT_T = "fixed-rate-inv-sqrt-t"
LR_SCHEDULER_FIXED_RATE_INV_T = "fixed-rate-inv-t"
LR_SCHEDULER_FIXED_RATE_LINEAR_DECAY = "fixed-rate-linear-decay"
...
LR_SCHEDULERS = [LR_SCHEDULER_FIXED_RATE_INV_SQRT_T,
                 ...
                 LR_SCHEDULER_FIXED_RATE_LINEAR_DECAY,

...
ENCODER_ADD_METADATA_LAST = 'last'
ENCODER_ADD_METADATA_ALL_TIED = 'all_tied'
ENCODER_ADD_METADATA_ALL = 'all'
ENCODER_ADD_METADATA_CHOICES = [ENCODER_ADD_METADATA_LAST, ENCODER_ADD_METADATA_ALL_TIED, ENCODER_ADD_METADATA_ALL]
...
INFERENCE_ARG_INPUT_METADATA_LONG = "--input-metadata"
INFERENCE_ARG_INPUT_METADATA_SHORT = "-imd"

...
DATA_SAMPLING_UNIFORM = 'uniform'
DATA_SAMPLING_TEMPERATURE = 'temperature'
DATA_SAMPLING_CUSTOM = 'custom'
DATA_SAMPLING_METHODS = [DATA_SAMPLING_UNIFORM, DATA_SAMPLING_TEMPERATURE, DATA_SAMPLING_CUSTOM]

DATA_RANDOM_REROUTING_UNIFORM = 'uniform'
DATA_RANDOM_REROUTING_WEIGHTED = 'weighted'
DATA_RANDOM_REROUTING_CHOICES = [DATA_RANDOM_REROUTING_UNIFORM, DATA_RANDOM_REROUTING_WEIGHTED]
...
FIXED_PARAM_STRATEGY_ALL_EXCEPT_BRANCHING = "all_except_branching"
...
FIXED_PARAM_STRATEGY_CHOICES = [FIXED_PARAM_STRATEGY_ALL_EXCEPT_DECODER,
                                ...
                                FIXED_PARAM_STRATEGY_ALL_EXCEPT_BRANCHING,

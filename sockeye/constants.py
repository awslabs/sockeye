...
POSITIVE_SCONES = 'perplexity'  # For compatibility, so that a "validation perplexity" exists when training with Scones
NEGATIVE_SCONES = 'negative_scones'
...
METRICS = [PERPLEXITY, ACCURACY, LENRATIO_MSE, BLEU, CHRF, ROUGE1, BOW_PERPLEXITY, TER, POSITIVE_SCONES, NEGATIVE_SCONES]
METRIC_MAXIMIZE = {ACCURACY: True, BLEU: True, CHRF: True, ROUGE1: True, PERPLEXITY: False, LENRATIO_MSE: False,
                   TER: False, BOW_PERPLEXITY: False, POSITIVE_SCONES: False, NEGATIVE_SCONES: False}
METRIC_WORST = {ACCURACY: 0.0, BLEU: 0.0, CHRF: 0.0, ROUGE1: 0.0, PERPLEXITY: np.inf, BOW_PERPLEXITY: np.inf, TER: np.inf, POSITIVE_SCONES: np.inf, NEGATIVE_SCONES: np.inf}
METRICS_REQUIRING_DECODER = [BLEU, CHRF, ROUGE1, ROUGE2, ROUGEL, TER]
EVALUATE_METRICS = [BLEU, CHRF, ROUGE1, ROUGE2, ROUGEL, TER, POSITIVE_SCONES, NEGATIVE_SCONES]

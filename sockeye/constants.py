...
# scoring
SCORING_OUTPUT_ID = 'id'
SCORING_OUTPUT_SCORE = 'score'
SCORING_OUTPUT_SOURCE = 'source'
SCORING_OUTPUT_TARGET = 'target'
SCORING_OUTPUT_UNKNOWN = '[UNKNOWN_TYPE]'
SCORING_OUTPUT_DEFAULT = SCORING_OUTPUT_SCORE
SCORING_OUTPUT_CHOICES = [SCORING_OUTPUT_SCORE, SCORING_OUTPUT_ID, SCORING_OUTPUT_SOURCE, SCORING_OUTPUT_TARGET]

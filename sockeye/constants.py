...
OUTPUT_HANDLER_NBEST_WITH_SCORE = "nbest_translation_with_score"
OUTPUT_HANDLER_NBEST_WITH_ALIGNMENTS = "nbest_translation_with_alignments"
OUTPUT_HANDLERS = [OUTPUT_HANDLER_TRANSLATION,
                   ...
                   OUTPUT_HANDLER_NBEST_WITH_SCORE,
                   OUTPUT_HANDLER_NBEST_WITH_ALIGNMENTS]

OUTPUT_HANDLERS_NBEST = [OUTPUT_HANDLER_NBEST,
                         OUTPUT_HANDLER_NBEST_WITH_ALIGNMENTS,
                         OUTPUT_HANDLER_NBEST_WITH_SCORE]

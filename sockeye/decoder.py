...
class RecurrentDecoderConfig(Config):
    ...
    :param enc_last_hidden_concat_to_embedding: concatenate the last hidden representation of
        the encoder to the input of the decoder (e.g., context + current embedding)
    :param dtype: Data type.
    """

...
def test_adjust_first_step_masking():
    ...
    adjust_first_step_mask = pt.tensor([[0., 0., 0.],
                                        ...
                                        [onp.inf, onp.inf, 0.],
                                        [onp.inf, onp.inf, 0.]])
    assert pt.equal(adjust_first_step_mask, bs.adjust_first_step_masking(target_prefix, first_step_mask)) == True
    ...
    adjust_first_step_mask = pt.tensor([[0., 0., 0., 0.],
                                        ...
                                        [onp.inf, onp.inf, 0., 0.],
                                        [0., 0., 0., 0.],
                                        [onp.inf, onp.inf, onp.inf, onp.inf],
                                        [onp.inf, onp.inf, onp.inf, onp.inf],
                                        [onp.inf, onp.inf, onp.inf, onp.inf]])
    assert pt.equal(adjust_first_step_mask, bs.adjust_first_step_masking(target_prefix, first_step_mask)) == True
    target_prefix = pt.tensor([[1, 0, 0, 0], [2, 3, 4, 5]])
    adjust_first_step_mask = pt.tensor([[0., 0., 0., 0., 0.],
                                        [onp.inf, onp.inf, 0., 0., 0.],
                                        [onp.inf, onp.inf, 0., 0., 0.],
                                        [onp.inf, onp.inf, 0., 0., 0.],
                                        [0., 0., 0., 0., 0.],
                                        [onp.inf, onp.inf, onp.inf, onp.inf, onp.inf],
                                        [onp.inf, onp.inf, onp.inf, onp.inf, onp.inf],
                                        [onp.inf, onp.inf, onp.inf, onp.inf, onp.inf]])
    assert pt.equal(adjust_first_step_mask, bs.adjust_first_step_masking(target_prefix, first_step_mask)) == True
    first_step_mask = pt.tensor([[0.],

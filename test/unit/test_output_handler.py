...
stream_handler_tests = [(sockeye.output_handler.StringOutputHandler(io.StringIO()),
                        ...
                        (sockeye.output_handler.NBestOutputHandler(io.StringIO()),
                         TranslatorInput(sentence_id=0, tokens=[], factors=[], constraints=[]),
                         TranslatorOutput(sentence_id=0, translation="ein Test", tokens=None,
                                          attention_matrix=None, score=0.,
                                          nbest_translations=["ein Test", "der Test"],
                                          nbest_tokens=[None, None],
                                          nbest_attention_matrices=[None, None],
                                          nbest_scores=[0., 0.1]),
                         0.5,
                         '["ein Test", "der Test"]\n'),
                        (sockeye.output_handler.NBestWithScoreOutputHandler(io.StringIO()),
                         TranslatorInput(sentence_id=0, tokens=[], factors=[], constraints=[]),
                         TranslatorOutput(sentence_id=0, translation="ein Test", tokens=None,
                                          attention_matrix=None, score=0.,
                                          nbest_translations=["ein Test", "der Test"],
                                          ...
                                          nbest_scores=[0., 0.1]),
                         0.5,
                         '{"scores": [0.0, 0.1], "translations": ["ein Test", "der Test"]}\n'),
                        (sockeye.output_handler.NBestWithAlignmentsOutputHandler(io.StringIO(), threshold=0.5),
                         TranslatorInput(sentence_id=0, tokens=[], factors=[], constraints=[]),
                         TranslatorOutput(sentence_id=0, translation="ein Test", tokens=None,
                                          attention_matrix=np.asarray([[0.4, 0.6],
                                                                       [0.8, 0.2],
                                          ...
                                          nbest_scores=[0., 0.1]),
                         0.5,
                         '{"alignments": [[[0, 1], [1, 0]], [[0, 1], [1, 0]]], "translations": ["ein Test", "der Test"]}\n')
                        ]

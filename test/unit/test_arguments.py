...
@pytest.mark.parametrize("test_params, expected_params", [
    ...
    ('--source test_src --target test_tgt --prepared-data prep_data '
     ...
     dict(source='test_src', target='test_tgt',
          ...
          data_sampling_method='uniform',
          data_sampling_temperature=1,
          data_sampling_custom=[],
          data_random_rerouting=0,
          data_random_rerouting_method=C.DATA_RANDOM_REROUTING_UNIFORM,
